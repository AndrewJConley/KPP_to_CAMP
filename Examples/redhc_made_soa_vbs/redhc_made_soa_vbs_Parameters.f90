...
! 
! File                 : redhc_made_soa_vbs_Parameters.f90
...
MODULE redhc_made_soa_vbs_Parameters
...
! NREACT - Number of reactions
  INTEGER, PARAMETER :: NREACT = 89 
! NVARST - Starting of variables in conc. vect.
  INTEGER, PARAMETER :: NVARST = 1 
! NFIXST - Starting of fixed in conc. vect.
  INTEGER, PARAMETER :: NFIXST = 49 
! NONZERO - Number of nonzero entries in Jacobian
  INTEGER, PARAMETER :: NONZERO = 320 
! LU_NONZERO - Number of nonzero entries in LU factoriz. of Jacobian
  INTEGER, PARAMETER :: LU_NONZERO = 334 
...
!   VAR(ind_spc) = C(ind_spc)
  ...
  INTEGER, PARAMETER :: ind_RXPAR_nt = 22 
  INTEGER, PARAMETER :: ind_TOLUENE = 23 
  INTEGER, PARAMETER :: ind_ROR = 24 
  INTEGER, PARAMETER :: ind_ROOH = 25 
  ...
  INTEGER, PARAMETER :: ind_ONIT = 31 
  INTEGER, PARAMETER :: ind_MBO = 32 
  INTEGER, PARAMETER :: ind_SESQ = 33 
  INTEGER, PARAMETER :: ind_PAR = 34 
  INTEGER, PARAMETER :: ind_C10H16 = 35 
  INTEGER, PARAMETER :: ind_ISOP = 36 
  INTEGER, PARAMETER :: ind_OLE = 37 
  INTEGER, PARAMETER :: ind_CH3CHO = 38 
  INTEGER, PARAMETER :: ind_CH2O = 39 
  INTEGER, PARAMETER :: ind_XO2N_nt = 40 
  INTEGER, PARAMETER :: ind_XO2_nt = 41 
  INTEGER, PARAMETER :: ind_O3 = 42 
  INTEGER, PARAMETER :: ind_OH_nt = 43 
  INTEGER, PARAMETER :: ind_HO2_nt = 44 
  INTEGER, PARAMETER :: ind_NO = 45 
  INTEGER, PARAMETER :: ind_NO2 = 46 
  INTEGER, PARAMETER :: ind_C2O3_nt = 47 
  INTEGER, PARAMETER :: ind_NO3_nt = 48 
...
END MODULE redhc_made_soa_vbs_Parameters
