...
! 
! File                 : redhc_made_soa_vbs_Main.f90
...
PROGRAM redhc_made_soa_vbs_Driver

  USE redhc_made_soa_vbs_Model
  USE redhc_made_soa_vbs_Initialize, ONLY: Initialize
...
END PROGRAM redhc_made_soa_vbs_Driver
