...
! 
! File                 : redhc_made_soa_vbs_Global.f90
...
MODULE redhc_made_soa_vbs_Global

  USE redhc_made_soa_vbs_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT
  PUBLIC
  SAVE
...
END MODULE redhc_made_soa_vbs_Global
